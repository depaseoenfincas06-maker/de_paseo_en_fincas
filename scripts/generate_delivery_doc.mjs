...
content.push(table(['Servicio', 'Para qué', 'Cuenta hoy', 'Qué debe hacer De Paseo en Fincas', 'Costo aprox.'], [
  ...
  ['Kapso (plataforma del número de WhatsApp)', 'A través de Kapso (proveedor tecnológico de Meta) se registró la línea +1 201-701-8810', 'Cuenta de Kapso con la cuenta de Google de De Paseo en Fincas', 'Nada por ahora; se entra en app.kapso.ai con Continuar con Google', 'Incluido'],
