...
content.push(table(['Servicio', 'Para qué', 'Cuenta hoy', 'Qué debe hacer De Paseo en Fincas', 'Costo aprox.'], [
  ...
  ['Servidor Hetzner (n8n + Chatwoot)', 'Aloja n8n (automatización), Chatwoot (bandeja de WhatsApp) y el conversor de PDF. Servidor "n8n-depaseoenfincas-hetzner", 4 CPU / 8 GB / 75 GB', 'Cuenta Hetzner de raaamp', 'Opción A: raaamp lo factura mensualmente. Opción B: abrir cuenta propia en Hetzner con su tarjeta y raaamp transfiere el proyecto (sección 2.4)', 'US$10/mes (verificado)'],
  ['Kapso (plataforma del número de WhatsApp)', 'A través de Kapso (proveedor tecnológico de Meta) se registró la línea +1 201-701-8810', 'Cuenta de Kapso de raaamp', 'raaamp revisa el plan en app.kapso.ai; si tiene costo, se factura o se traslada la cuenta (ver Guía de cuentas y métodos de pago)', 'Según plan (verificar)'],
